...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`flex w-full h-16 justify-center bg-blue-600 text-white shadow-md fixed top-0 z-50 transition-transform duration-300 ${
      ...
      {/* Main content wrapper with margin-top to avoid overlap */}
